...
// Nodes having both child(left child and right child) are called full nodes
...
class FullNode{
	...
	public ArrayList<Integer> getFullNodes(Node root){
...
public class FullNodesInBinaryTree {
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> res = fn.getFullNodes(root);
